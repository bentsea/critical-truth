...
The Thing shares common properties with other monsters that convert their prey, bolstering their number by consumption, such as vampires, pod people, and the like. However, the body horror induced bye the violent conversion of the consumed as the infestation spreads from host to host is so extreme, and the totally converted hosts are so completely normal and unchanged, that the dread more successfully explores the feeling of being alone and in constant danger rather than deeper metaphors about the monster itself.
...
As a compounding element to this, the subtle fear that not only might have lost themselves, but that in doing so they may have made it possible for a thing so virulent that it will destroy the world to escape.
